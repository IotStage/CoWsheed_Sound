...
public class Design extends PreferenceActivity
{
    private ProgressDialog pDialog;

    JSONParser jsonParser = new JSONParser();
    private static String url_create_product = "http://10.130.1.1/dispo.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                Design.CreateNewProduct task = new CreateNewProduct();
                task.execute();
                return true;
            }
        });
       ...
       // bindPreferenceSummaryToValue(findPreference("Salle"));
        bindPreferenceSummaryToValue(findPreference("Lit"));
    }
    @Override
    ...
    class CreateNewProduct extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(Design.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String hopital = listPreference10.getValue();
            ListPreference listPreference1 = (ListPreference) findPreference("Service");
            //CharSequence Service = listPreference1.getEntry();
            //String service = (String)Service;
            //ListPreference listPreference2 = (ListPreference) findPreference("Salle");
            String service = listPreference1.getValue();
            ListPreference listPreference3 = (ListPreference) findPreference("Lit");
           ...
           // params.add(new BasicNameValuePair("salle",salle));
            params.add(new BasicNameValuePair("lit",lit));
